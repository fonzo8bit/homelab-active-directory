Active Directory Home Lab — Built a virtualized Windows Server 2022 environment using VMware Workstation to simulate enterprise IT infrastructure for a home health care agency.
What I configured:

Organizational Units modeled after a real workplace (IT Support, HR, Administration, Coordinators),
User accounts with cross-department group memberships,
Password Policy GPO — 8 character minimum, complexity requirements, 90 day expiration,
Screen Lock Policy GPO — automatic lock after 5 minutes of inactivity
